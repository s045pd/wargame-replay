import { useHotspotFilter, ALL_HOTSPOT_TYPES, ALL_PERSONAL_EVENT_TYPES, type HotspotType, type PersonalEventType } from '../store/hotspotFilter';
...
/** Colour per personal event type — matches HotspotTrack personal mode */
 ...
 * global hotspot types to personal event types.
 */
export function HotspotControlPanel() {
  ...
  // Count events per personal event type for the followed unit
    ...
    <div className="absolute bottom-8 right-2 z-10 bg-zinc-900/90 border border-zinc-700 rounded px-2.5 py-2 text-xs font-mono backdrop-blur-sm min-w-[160px]">
      ...
      {isPersonalMode ? (
        <>
          ...
          {/* Per-personal-event-type filter buttons */}
